---
layout: post
title: "Latest addons: week 44"
description: "This is an overview of the community addons released in week 44 for Flight Simulator 2020"
tags:
...
- FS2020 liveries
category: tutorials
permalink: /MSFS2020-Latest-Added-Week-44/
date:  2020-11-02
---
...
<table>
    <tr>
     ...
     {% for scenery in sceneries %}
        ...
        {% assign last_week = "2020-11-01" | date: "%s" |minus: timeframe %}
        {% assign this_week = "2020-11-01" | date: "%s" | plus: 0 %}
