---
layout: post
title: "Latest addons: week 45"
description: "This is an overview of the community addons released in week 45 for Flight Simulator 2020"
tags:
...
<table>
    <tr>
     ...
     {% for scenery in sceneries %}
        ...
        {% assign last_week = "2020-11-08" | date: "%s" |minus: timeframe %}
        {% assign this_week = "2020-11-08 | date: "%s" | plus: 0 %}
