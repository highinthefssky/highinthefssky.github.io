---
layout: post
title: "Latest addons: week 41"
description: "This is an overview of the community addons released in week 41 for Flight Simulator 2020"
tags:
...
- FS2020 liveries
category: tutorials
permalink: /MSFS2020-Latest-Added-Week-41/
date:  2020-10-12
---

Below an overview of the addons released in week 41:
...
<table>
    <tr>
     ...
     {% for scenery in sceneries %}
        ...
        {% assign last_week = "2020-10-11" | date: "%s" |minus: timeframe %}
        {% assign this_week = "2020-10-11" | date: "%s" | plus: 0 %}
